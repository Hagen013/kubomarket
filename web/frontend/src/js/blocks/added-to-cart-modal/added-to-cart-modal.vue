<template>
    <modal @close="$emit('close')" 
            ...
            :sizesStyleName="'added-to-cart-modal__content'">
        <div>
            <div class="float-item added-to-cart-modal__left-ancor">
                <img :src="img" alt="вы добавили корзину" class="added-to-cart-modal__img">
            </div>
