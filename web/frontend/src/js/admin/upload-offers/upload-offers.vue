    ...
    <md-content>
        <div class="md-layout">
            <div class="md-layout-item">
                <md-card>
                    <md-card-header>
                        <div class="md-title">Загрузка новых товаров</div>
                    </md-card-header>
                    <md-card-content>
                        <md-field>
                            <label>Файл новых товаров</label>
    ...
    export default {
        ...
        methods: {
            ...
            uploadFileTriggered() {
                ...
                this.$http.post('/controls/upload-offers/', formData).then(
                    response => {
            ...
            getUploadStatus() {
                this.$http.get('/controls/upload-offers/').then(
                    response => {
