# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2018-09-07 14:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_id', models.PositiveIntegerField(default='787955', verbose_name='ID магазина')),
                ('scid', models.PositiveIntegerField(default='787955', verbose_name='Номер витрины')),
                ...
                ('success_url', models.URLField(default='https://kubomarket.ru/ym/success-payment/', verbose_name='URL успешной оплаты')),
                ('fail_url', models.URLField(default='https://kubomarket.ru/ym/fail-payment/', verbose_name='URL неуспешной оплаты')),
