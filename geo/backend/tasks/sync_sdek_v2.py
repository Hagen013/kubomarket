...
async def calculate_row(index, tariff_id, receiver_city_id, weight, session):
    ...
    async with session.post(
        ...
        if resp.status == 200:
            ...
            #     city = SdekCityList.objects.get(city_id=receiver_city_id).city_name
            #     print(city)
...
def sync_sdek():
    ...
    with transaction.atomic():
        for _, row in df.iterrows():
            ...
            print(sdek_city.city_name)
            print(sdek_city.price_sd_ex_1kg)
            print(sdek_city.price_sd_pkg_3kg)
            print(sdek_city.price_ss_ex_1kg)
            print(sdek_city.price_ss_pkg_3kg)
